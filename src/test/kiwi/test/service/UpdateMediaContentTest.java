	...
	public void initCurrentContentItem() throws Exception {
    	...
    	new FacesRequest() {
            ...
            protected void invokeApplication() throws Exception {
            	...
            	final ContentItemService cs = (ContentItemService) Component.getInstance("contentItemService");
            	final RevisionService revisionService = (RevisionService) Component.getInstance("revisionService");
            	...
            	revisionService.restore(version.getRevision());
            }
    	}.run();
    	...
    	new FacesRequest() {
            ...
            protected void invokeApplication() throws Exception {
            	...
            	if(item == null) {
            		System.out.println("ContentItem with filename " + fileName1 + " not found");
            		item = cs.getContentItemByTitle(fileName2);
            		if(item != null) {
            			System.out.println("ContentItem with filename " + fileName2 + " found");
            		}
            	}
