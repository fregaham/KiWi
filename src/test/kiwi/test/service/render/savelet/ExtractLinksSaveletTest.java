...
public class ExtractLinksSaveletTest {
	...
	public void testApply() {
		...
		assertEquals("<a kiwi:kind=\"intlink\" kiwi:target=\"Test\" rel=\"rdf:type\" href=\"\">Test</a> ",result);
		
		String content04 = "[[rdf:type :: Test | Test Label]]";
		result = savelet.apply(null,content04);
		
		assertEquals("<a kiwi:kind=\"intlink\" kiwi:target=\"Test\" rel=\"rdf:type\" href=\"\">Test Label</a> ",result);
	}
