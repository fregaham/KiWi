/*
 * File : PoststgresStoreProcedureBuilder.java.java
 * Date : Sep 29, 2010
 * 
 *
...
/**
 * Used to builds Postgresql like SQL statements. <br>
 ...
 * @since 0.9
 */
final class PoststgresStoreProcedureBuilder implements StoredProcedureBuilder {
    ...
    private static final StoredProcedureBuilder THIS =
            new PoststgresStoreProcedureBuilder();

    /**
     * Don't let anybody to instatiate this class.
     */
    private PoststgresStoreProcedureBuilder() {
        // UNIMPLEMENTED
    }
