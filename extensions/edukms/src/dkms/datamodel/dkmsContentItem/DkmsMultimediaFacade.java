...
@KiWiFacade
@RDFType(Constants.DKMS_CORE + "Multimedia")
public interface DkmsMultimediaFacade extends ContentItemI{
	 ...
	 */
	@RDF(Constants.DKMS_CORE + "multimediaText")	
	public LinkedList<DkmsMultimediaTextFacade> getMultimediaText();
	/**
	 * @param mediaContentText the mediaContentText to set
	 */
	public void setMultimediaText(LinkedList<DkmsMultimediaTextFacade> mediaContentText);
	/**
