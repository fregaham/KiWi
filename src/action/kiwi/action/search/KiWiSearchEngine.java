...
public class KiWiSearchEngine implements Serializable, SearchEngine {
	...
	public void runSearch() {
		//reset page
		page = 1;
		log.info("clear pages");
		runSearchWithoutClear();
	}
	
	public void runFromInside() {
		insideSearch = true;
		runSearch();
	}
	
	public void runSearchWithoutClear() {
	...
	public void addSearchType(KiWiResource type) {
		...
		if(namespace != null) {
			...
			searchQuery = searchQuery + " type:\"" + kiwiIdentifier + "\"";
		}
...
//			});
	...
	public boolean isInsideSearch() {
		if( insideSearch ) {
			insideSearch = false;
			return true;
		} else return insideSearch;
	}
