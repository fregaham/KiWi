...
final class JBossHelper {
    ...
    private final static Logger LOG = Logger.getLogger(JBossHelper.class
            .getName());
    ...
    static void cleanJBoss(String jBossDir) {
        ...
        LOG.finest("Tries to remove :" + toRemove + " from "
                + serverDefaultLibDir);
    ...
    static void processPersistence(final File defaulPersitence,
        ...
        final String solrHome = kiwiHome + File.separator + "solr";
        parser.setSolrHome(solrHome);
        final String gateHome = kiwiHome + File.separator + "gate";
        parser.setGateHome(gateHome);
        // mihai : I am not sure if teh dir must be the same for
        // semantic vectors and sorl
        parser.setSemanticVectorDir(solrHome);
