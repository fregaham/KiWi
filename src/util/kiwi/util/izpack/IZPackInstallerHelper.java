...
public class IZPackInstallerHelper {
    ...
    public static void main(String[] args) throws IOException,
        ...
        if (args.length != 10) {
            final String msg =
                    String.format("The argument number is %d, expected was 10.");
        ...
        final String defaultPort = args[8];
        final String sslPort = args[9];
        ...
        msg.append("Default HTTP port: ");
        msg.append(defaultPort);
        msg.append("\n");

        msg.append("SSL HTTP port : ");
        msg.append(sslPort);
        msg.append("\n");
        ...
        final File serverFile =
                new File(kiwiHome + File.separator + "server-defalut.xml");
        ServerHelper.processServer(serverFile, jBossHome, defaultPort, sslPort);
        serverFile.delete();
    }
}
