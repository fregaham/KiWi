 ...
 * database must follow the Hyperdrive standards, in this way the
 * :
 * <ul>
...
final class H2ProcedureProcessor implements StoringProcedureProcessor {
    ...
    /**
     * Builds a <code>H2ProcedureProcessor</code> for a given
     * list of arguments. See the class comments for details
     * about the possible arguments values.
     * 
    ...
    public void process(String procedure)
        ...
        try {
            ...
            // It is not recommend to catch all exceptions but in
// this case I
