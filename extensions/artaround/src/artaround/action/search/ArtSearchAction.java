...
public class ArtSearchAction implements Serializable {
	...
	private Map<String, Set<String>> techniqueMap; 
	...
	public String reset() {
		...
		techniqueMap = new HashMap<String, Set<String>>();
	...
	private String run(Map<String, Set<String>> techniqueMap) {
		try {			
...
//				ksc.setSolrSearchString(crit);
	...
	public String setTechniqueResource(KiWiUriResource techniqueResource) {						
		...
		techniqueMap.put("http://www.artaround.at/techniques", kiwiResource2Uri(selectedTechniques));
