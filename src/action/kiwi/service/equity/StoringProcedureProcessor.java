/*
 * File : StoringProcedureProcessor.java.java Date : Apr 13, 2010 DO NOT ALTER
 * OR REMOVE COPYRIGHT NOTICES OR THIS HEADER. Copyright 2008 The KiWi Project.
 * All rights reserved. http://www.kiwi-project.eu The contents of this file are
...
/**
 * It unifies the way how the stored procedures are processed by
 * the KiWi system.
 * 
 * @author mradules
 * @version 0.9
 ...
 */
@Deprecated
interface StoringProcedureProcessor {

    /**
     * Processed a given stored procedures.
     * 
     * @param procedure the stored procedure to process.
     * @throws StoringProcedureProcessorException by any
     *             exception.
     */
    void process(String procedure) throws StoringProcedureProcessorException;
}
