...
(function($){
	$.widget("kiwi.ceqchart", {
		...
		getStart: function() {
			return this._getData?this._getData("start"):this.option()["start"];
		},
		
		getEnd: function() {
			return this._getData?this._getData("end"):this.option()["end"];
		}
	});
	...
	$.kiwi.ceqchart.defaults = {
		webServiceUrl: 'http://localhost:8080/KiWi/seam/resource/services/widgets/ceq/chart/image',
        uri:           'http://localhost/content/FrontPage',
		start:         null,
		end:		   null
	};
	$.kiwi.ceqchart.prototype.options = $.kiwi.ceqchart.defaults;
})(jQuery);
