 ...
 * FIXME : this class does not belong in a izpack related
 * package, it is a general purposed class
 * 
 * @author mradules
 */
public enum DatabaseSystem {
     ...
     */
    HYPERDRIVE("Hyperdrive", "org.h2.Driver",
            "org.hibernate.dialect.H2Dialect", "jdbc:h2:tcp://localhost/~/");
    ...
    public static String getDatabaseName(final String url, final String driver) {
    ...
    public static DatabaseSystem getDatabaseForName(String name) {
    ...
    public static DatabaseSystem getDatabaseForToString(String toString) {
        for (final DatabaseSystem databaseSystem : values()) {
    ...
    public static DatabaseSystem getDatabaseForDriver(String driver) {
        for (final DatabaseSystem databaseSystem : values()) {
    ...
    public static DatabaseSystem getDatabaseForDialect(String dialect) {
        for (final DatabaseSystem databaseSystem : values()) {
    ...
    public static String getdatabaseURL(DatabaseSystem databaseSystem,
